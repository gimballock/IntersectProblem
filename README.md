...
`package-lock.json`: Documents npm packages installed along with their versions. Used by `npm` to allow other users to exactly reproduce the same build as me or at least attempt to.
